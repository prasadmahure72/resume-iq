...
function SuccessView({ email }: SuccessViewProps) {
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-md px-8 py-12 lg:px-10 text-center">
      ...
      <p className="text-text-secondary text-sm leading-relaxed mb-2 max-w-xs">
...
export function SignUpForm() {
  ...
  if (confirmedEmail) {
    return <SuccessView email={confirmedEmail} />
  }
